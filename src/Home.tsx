                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                        ...
                        <div className="tw-text-pink-primary fs-12px tw-h-fit-content tw-my-auto tw-border tw-border-solid tw-border-pink-primary tw-rounded-md tw-px-2 tw-py-1 tw-w-fit-content tw-tracking-widest">
                          ESCROW 1d
                                                            ...
                                                            <div className="tw-border tw-border-solid tw-border-purple-1 tw-p-2 tw-rounded-md tw-text-white-1 tw-h-fit-content tw-text-[14px] tw-flex tw-gap-2 tw-whitespace-nowrap">
                                                                ...
                                                                <span className="tw-font-bold">4444</span>
                                                            </div>
                      ...
                      <div className="tw-flex tw-items-center tw-gap-2">
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                                                                        href="https://discord.com/invite/TNhbYV8Swp"
                          >
                            <img
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                                                                        href="https://twitter.com/SolfulNFT"
                          >
                            <img
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                            4444 Solful creatures wandering around the
                                                            peaceful forest. Building a cross-chain NFT
                                                            networking website and a story.
                    </p>
                    ...
                    <div className="tw-w-full">
                      <div className="tw-flex tw-flex-col tw-gap-1 tw-flex-grow 3xl:tw-hidden">
                        <div className="tw-flex tw-items-center tw-justify-between tw-text-[14px] tw-text-gray-5">
                          ...
                          <span>
                            <b className="tw-text-white-1">95%</b> (4221/4444)
                          </span>
                        </div>
                  ...
                  <div className="tw-flex tw-flex-1 tw-flex-col md:tw-flex-row tw-mx-auto tw-gap-32 tw-pb-20 tw-justify-between">
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div className="tw-flex tw-flex-wrap tw-gap-4">
                        ...
                        <a
                                                                    href="https://solful.io/whitepaper-1"
                          target="_blank"
                          rel="noreferrer noopener"
                          className="tw-border tw-border-solid tw-border-purple-1 tw-flex tw-items-center tw-gap-2 tw-w-fit tw-rounded-full tw-px-2.5 tw-py-1.5 tw-text-white-2"
                        >
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                    SOLFUL will be developing a cross-chain NFT
                                                                    networking website for Web 3.0 environment
                                                                    that will benefit both the public with exposure
                                                                    and the holders with royalties and further
                                                                    website usability.

                                                                    Featuring job boards, personal and project
                                                                    profile CVs, collaboration management,
                                                                    featured categories and services - SOLFUL
                                                                    is bringing all the connections to one place.
                                                                    All while retaining users privacy by being
                                                                    able to use their NFT / crypto world
                                                                    identity.

                                                                    Our creatures have been designed to represent
                                                                    clean and simple environment and versatile
                                                                    usability in various real life or digital cases
                                                                    with a creative lore and immerse experience
                                                                    attached to each creature and the whole SOLFUL story.

                                                                    The goal is to create a community that helps
                                                                    users to express themselves in what they
                                                                    are best at, connect with ease and establish
                                                                    partnerships with other projects who are aiming
                                                                    to do the same.
                                                                    <img
                                                                        src="./img/downImage.png"
                                                                        alt="Cynova"
                                                                        className="tw-object-cover tw-aspect-square tw tw-w-screen tw-flex-grow tw-rounded-3xl overflow-hidden"
                                                                    />
                                                            </p>
                        ...
                        <div className="tw-p-4">
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                            Coffence: Co-founder and artist
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
                                                                    <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                            Creative and project flow management. An artist
                                                                            and a digital nomad that gave up traditional
                                                                            media in 2010 and has been drawing on screen
                                                                            ever since all while traveling around with
                                                                            the idea of change lingering around. In pursue
                                                                            of finding a meaningful way to merge personal
                                                                            digital art together with newest technology,
                                                                            met another traveler and together wondered into
                                                                            the universe of blockchains finding a way to add
                                                                            up a piece in the puzzle. This puzzle piece
                                                                            quickly attained the name of SOLFUL and the
                                                                            journey of connection has started to unravel.
                                                                            Bustling with ideas, putting high value on
                                                                            independence and fully transitioning into
                                                                            Web3 we decided to develop a place to help
                                                                            others do the same.
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                                    Technical plan management. Passionate technology
                                                                                    biomedical engineer working as an IT manager in ERP
                                                                                    solutions. Came into NFT sphere while being a digital
                                                                                    nomad, met an artist and built the team. While
                                                                                    managing various types of projects in real life,
                                                                                    I'm adding up my experience to provide technical
                                                                                    development help of SOLFUL's networking website
                                                                                    that will benefit the whole NFT and Web3 community.
                            </p>
                            <br />
                          </div>
